...
public class AboutMenuFragment extends Fragment implements LicenseReaderListener {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    versionBox.setText(((CommonApplication) getActivity().getApplication()).getVersionedAppName());
  ...
  private void readLicenseFile() {
    ...
    ((CommonApplication) getActivity().getApplication()).readLicenseFile(appName, this);
  }
