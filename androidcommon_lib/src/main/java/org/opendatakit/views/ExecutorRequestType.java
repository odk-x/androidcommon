...
public enum ExecutorRequestType {
  ...
  LOCAL_TABLE_CREATE_TABLE,
  LOCAL_TABLE_DELETE_TABLE,
  LOCAL_TABLE_INSERT_ROW,
  LOCAL_TABLE_UPDATE_ROW,
  LOCAL_TABLE_DELETE_ROW,
  LOCAL_TABLE_SIMPLE_QUERY,
  LOCAL_TABLE_ARBITRARY_QUERY
}
