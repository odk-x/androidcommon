...
public class ElementType {
  ...
  public boolean equals(Object o) {
    ...
    return (getDataType() == other.getDataType()) &&
           ...
           ((getAuxInfo() == null) ? (other.getAuxInfo() == null) 
               : getAuxInfo().equals(other.getAuxInfo()));    
  }
  ...
  public String toString() {
    ...
    if ( dataType == ElementDataType.object ||
         dataType.name().equals(elementType) ||
  ...
  public static final ElementType parseElementType(String type, boolean hasChildren) {
    ...
    String auxInfo = (idxCloseParen != -1 && idxOpenParen != -1) ?
        type.substring(idxOpenParen, idxCloseParen+1) : null;
    ...
    if ( hasChildren && 
        !(dataType == ElementDataType.object || dataType == ElementDataType.array ) ) {
      throw new IllegalArgumentException("malformed ElementType - invalid primitive name for elementType that is an object type");
    }
    ...
    if ( elementDataType != null && elementDataType != dataType ) {
      throw new IllegalArgumentException("malformed elementType -- attempting to explicitly re-type a primitive type");
    }
